...
\begin{frame}{Course structure}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item \emph{Automatic} theorem proving using Z3
      \item Dependent types and certified programming
      \item \emph{Interactive} theorem proving using Coq
    \end{itemize}
...
\begin{equation*}
S = \pause \setdef{\pair{off,t}}{t \in \R_0^+} \cup \setdef{\pair{on,t}}{0 \leq t \leq 2} 
\end{equation*}
